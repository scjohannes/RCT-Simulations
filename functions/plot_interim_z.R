...
plot_interim_z <- function(data_trials, data_crit_z, filter_trial = NULL, x_breaks = NULL, design = design$typeOfDesign, event_rate = death0, title_suffix = "", ylim_range = NULL) {
  p <- data_trials %>%
